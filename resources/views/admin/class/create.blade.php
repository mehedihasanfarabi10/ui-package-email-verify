                        ...
                        <div class="form-container">
                            ...
                            <form action="{{route('store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="class_name" value="{{old('class_name')}}" class="form-control @error('class_name') is-invalid @enderror  " id="class"  placeholder="Enter your class" required>
                                @error('class_name')
